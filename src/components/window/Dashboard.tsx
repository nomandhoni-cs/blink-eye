...
import { ClockIcon, SaveIcon, TextIcon, WallpaperIcon } from "lucide-react";
...
const Dashboard = () => {
  ...
  return (
    <div className="p-2 space-y-3">
      ...
      {/* <IdleTimeButton /> */}
      {/* Settings Section */}
      <Card className="bg-black/10 backdrop-blur-3xl">
        <CardContent className="p-5">
          <div className="flex space-x-4">
            <div className="flex flex-col justify-between  space-y-2 border-white/20 border-r pr-4">
              <div>
                ...
                <div className="flex items-center">
                  ...
                  />
                  <div className="bg-muted px-4 py-2 rounded-r-md text-sm border border-l-0 border-input">
                    minutes
                  </div>
                </div>
              </div>
