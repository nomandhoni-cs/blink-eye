    ...
    <section className="w-full py-12 relative overflow-hidden">
      <div className="container mx-auto px-4 relative z-10">
        <div className="mx-auto max-w-4xl text-center mb-12">
          <h2 className="mt-2 text-balance text-4xl font-heading tracking-wide sm:text-5xl md:text-6xl bg-gradient-to-r from-[#ff80b5] via-[#FE4C55] to-[#9089fc] bg-clip-text text-transparent">
        ...
        <div className="mt-16 space-y-24">
          {featuresDemo.map((feature, index) => (
            <div key={index} className="relative group">
              ...
              <div className="absolute -inset-6 bg-gradient-to-r from-blue-500/20 via-purple-500/20 to-pink-500/20 rounded-3xl blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>

              {/* Main glassmorphism card */}
              <Card className="relative overflow-hidden border border-white/20 dark:border-white/10 shadow-2xl backdrop-blur-xl bg-white/10 dark:bg-black/20 transition-all duration-500 hover:bg-white/20 dark:hover:bg-black/30 rounded-2xl">
                  ...
                  <div className="flex flex-col">
                      ...
                      <div className="relative group/image">
                        ...
                        <div className="relative bg-white/10 dark:bg-black/20 rounded-t-2xl overflow-hidden shadow-2xl backdrop-blur-xl border-b border-white/20 dark:border-white/10 hover:border-white/30 dark:hover:border-white/20 transition-all duration-500">
                          ...
                          <div className="h-12 bg-white/20 dark:bg-black/30 backdrop-blur-sm flex items-center justify-between px-6 border-b border-white/20 dark:border-white/10">
                            ...
                            <div className="flex-1 mx-6 px-4 py-1 bg-white/10 dark:bg-black/20 backdrop-blur-sm rounded-lg border border-white/20 dark:border-white/10">
                    ...
                    <div className="w-full p-8 lg:p-12 space-y-6 relative">
                      ...
                      <div className="relative z-10">
                        <Badge
                          variant="secondary"
                          className="mb-4 text-sm font-medium bg-white/20 dark:bg-white/10 text-slate-700 dark:text-slate-200 border border-white/30 dark:border-white/20 backdrop-blur-sm"
                        >
                          Feature {index + 1}
                        </Badge>

                        <h3 className="text-2xl sm:text-3xl lg:text-4xl font-heading text-slate-800 dark:text-slate-100 mb-4">
                          {feature.title}
                        </h3>

                        <p className="text-slate-600 dark:text-slate-300 text-lg leading-relaxed mb-6 max-w-4xl">
                          {feature.description}
                        </p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          {feature.features.map((item, i) => (
                            <div
                              key={i}
                              className="flex items-center space-x-3 text-slate-700 dark:text-slate-200 p-3 rounded-lg bg-white/10 dark:bg-black/20 backdrop-blur-sm border border-white/20 dark:border-white/10"
                            >
                              <div className="p-1 rounded-full fill-gradient-to-r from-blue-500 to-purple-500 shadow-lg flex-shrink-0">
