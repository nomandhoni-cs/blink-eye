            ...
            <div className="flex flex-col items-center w-full sm:w-[300px] space-y-2">
              ...
              <div className="flex items-center bg-[#FE4C55] h-16 py-4 pr-2 rounded-full">
                ...
                {downloadLinks.windowsSetup && (
                  <Button className="bg-[#FE4C55]  h-16 py-4 px-6 rounded-full flex items-center space-x-1 w-full">
                    <Link
                ...
                {/* 10% dropdown for other download options */}
                <DropdownMenu>
                  <DropdownMenuTrigger className="flex items-center justify-center">
                    <span className="text-sm p-2">▼</span>
                  </DropdownMenuTrigger>
                  <DropdownMenuContent>
                    <DropdownMenuLabel>Download for Windows</DropdownMenuLabel>
                    <DropdownMenuSeparator />
                    {downloadLinks.windowsSetup && (
                      <DropdownMenuItem>
                        <Link
              ...
              {downloadLinks.macSilicon && (
                <Button className="bg-[#FE4C55]  h-16 py-4 px-6 rounded-full flex items-center space-x-1 w-full">
                  ...
                  >
                    ...
                    <span className="text-sm">Download for MacOS</span>
                  </Link>
                </Button>
              )}

              {/* 10% dropdown for other Mac download options */}
              <DropdownMenu>
                <DropdownMenuTrigger className="flex items-center justify-center p-2 w-full">
                  <span className="text-sm">▼</span>
                </DropdownMenuTrigger>
                <DropdownMenuContent>
                  <DropdownMenuLabel>Download for Mac</DropdownMenuLabel>
                  <DropdownMenuSeparator />
                  {downloadLinks.macSilicon && (
                    <DropdownMenuItem>
                      <Link
            ...
            <div className="flex flex-col items-center w-full sm:w-[300px] space-y-2">
              ...
              <div className="flex items-center bg-[#FE4C55] h-16 py-4 pr-2 rounded-full">
                ...
                {downloadLinks.linuxDeb && (
                  <Button className="bg-[#FE4C55]  h-16 py-4 px-6 rounded-full flex items-center space-x-1 w-full">
                    ...
                    >
                      ...
                      <span className="text-sm">Download for Linux</span>
                    </Link>
                  </Button>
                )}
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent>
                    <DropdownMenuLabel>Download for Linux</DropdownMenuLabel>
                    <DropdownMenuSeparator />
                    ...
                    {downloadLinks.linuxTar && (
                      <DropdownMenuItem>
                        ...
                        >
                          <DownloadIcon className="w-5 h-5" />
                          <span className="text-sm">Download (Tar)</span>
                        </Link>
                      </DropdownMenuItem>
                    )}
                  </DropdownMenuContent>
